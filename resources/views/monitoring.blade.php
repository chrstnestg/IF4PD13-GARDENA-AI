...
<head>
    ...
    <title>Monitoring - GARDENA-AI</title>
    ...
    <div class="px-10 py-8">
        ...
        <div class="grid grid-cols-4 gap-5 mb-8">
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                ...
                {{-- Progress Bar --}}
                <div class="relative w-full h-2 rounded-full mb-1 overflow-hidden" style="background: linear-gradient(to right, #3b82f6, #22c55e, #f59e0b, #ef4444);">
                ...
                <div class="flex justify-between text-xs text-gray-400 mb-3">
                    <span>10°</span>
                    <span>Range Optimal</span>
                    <span>40°</span>
                </div>
                <div class="flex justify-between text-xs text-gray-500 border-t border-gray-100 pt-3">
                    <div>
                        <p class="text-gray-400">MIN 24H</p>
                        <p class="font-semibold">22.1°</p>
                    </div>
                    <div>
                        <p class="text-gray-400">MAX 24H</p>
                        <p class="font-semibold">29.8°</p>
                    </div>
                    <div>
                        <p class="text-gray-400">AVG</p>
                        <p class="font-semibold">25.6°</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between mb-3">
                    <div class="flex items-center gap-2">
                        <i class="fa-solid fa-bolt-lightning" style="color: rgb(255, 212, 59);"></i>
                        <span class="text-sm font-semibold text-gray-700">EC Larutan</span>
                    </div>
                    <span class="text-xs text-yellow-600 border border-yellow-300 rounded-full px-2 py-0.5">Peringatan</span>
                </div>
                <p class="text-4xl font-extrabold text-gray-800 mb-1">3.8<span class="text-lg font-semibold">mS/cm</span></p>
                <div class="relative w-full h-2 rounded-full mb-1 overflow-hidden" style="background: linear-gradient(to right, #3b82f6, #22c55e, #f59e0b, #ef4444);">
                    <div class="absolute top-[-2px] h-4 w-1 bg-white border border-gray-400 rounded" style="left: 76%;"></div>
                </div>
                <div class="flex justify-between text-xs text-gray-400 mb-3">
                    <span>0</span>
                    <span>Batas: 3.5</span>
                ...
                <div class="flex justify-between text-xs text-gray-500 border-t border-gray-100 pt-3">
                    ...
                    <div>
                        ...
                        <p class="font-semibold text-green-500">Naik</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
                ...
                <p class="text-4xl font-extrabold text-gray-800 mb-1">5.7<span class="text-lg font-semibold">pH</span></p>
                <div class="relative w-full h-2 rounded-full mb-1 overflow-hidden" style="background: linear-gradient(to right, #3b82f6, #22c55e, #f59e0b, #ef4444);">
                    <div class="absolute top-[-2px] h-4 w-1 bg-white border border-gray-400 rounded" style="left: 40%;"></div>
                </div>
                <div class="flex justify-between text-xs text-gray-400 mb-3">
                    <span>0</span>
                ...
                <div class="flex justify-between text-xs text-gray-500 border-t border-gray-100 pt-3">
                    <div>
                        <p class="text-gray-400">MIN 24H</p>
                        <p class="font-semibold">5.4</p>
                    </div>
                    <div>
                        <p class="text-gray-400">MAX 24H</p>
                        <p class="font-semibold">6.2</p>
                    </div>
                    <div>
                        <p class="text-gray-400">TREND</p>
                        <p class="font-semibold text-blue-500">Turun</p>
                    </div>
                </div>
            </div>
        ...
        <div class="grid grid-cols-3 gap-6">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="bg-gray-100 rounded-xl p-5">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Update terakhir: 24 Sep 2025, 14:30 WIB</p>
                </div>
                ...
                <div class="bg-white rounded-xl p-5 shadow-sm border border-gray-100 flex-1">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <a href="#" class="text-xs text-green-600 font-semibold flex items-center gap-1 hover:underline">
                            Kelola →
                        </a>
                    </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2">
                            ...
                            <div>
                                <p class="text-xs font-semibold text-gray-700">EC Larutan Tinggi</p>
                                <p class="text-xs text-gray-400">3.8 mS/cm - 14:28 WIB</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2">
                            <div class="w-1 h-8 bg-green-500 rounded"></div>
                            <div>
                                ...
                                <p class="text-xs text-gray-400">5.7 pH - 14:15 WIB</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2 bg-gray-50 rounded-lg px-3 py-2">
                            <div class="w-1 h-8 bg-green-500 rounded"></div>
                            <div>
                                ...
                                <p class="text-xs text-gray-400">72% RH - 14:00 WIB</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        const sensorChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Suhu (°C)',
                        data: [25.1, 25.8, 26.2, 26.4, 26.0, 25.7, 26.1],
                        borderColor: '#f59e0b',
                    ...
                    {
                        label: 'EC (mS/cm)',
                        data: [3.2, 3.4, 3.5, 3.8, 3.7, 3.6, 3.8],
                        borderColor: '#22c55e',
                    ...
                    {
                        label: 'pH',
                        data: [6.1, 5.9, 5.8, 5.7, 5.8, 5.7, 5.7],
                        borderColor: '#a855f7',
